...
const BulkActionBar = forwardRef<HTMLDivElement, BulkActionBarProps>(
  function BulkActionBar(
    { selectedCount, selectedIds, onClear, onBulkFavorite, allSaved, collections, isInCollection, onToggleInCollection, onCreateCollection },
    ref
  ) {
    ...
    // Close popover on outside click — but NOT on clicks inside the bar itself (handled by forwardRef parent)
    useEffect(() => {
      ...
      >
        ...
        <div className="relative" ref={popoverRef}>
          ...
          >
            ...
            {collections.length === 0 ? 'New Collection' : 'Add to Collection'}
          </button>
